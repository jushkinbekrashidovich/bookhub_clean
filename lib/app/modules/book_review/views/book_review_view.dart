      ...
      (() => Scaffold(
            ...
            body: Column(
              children: [
                ...
                CarouselSlider(
                  items: [
                    ...Get.find<HomeController>().allAds.value.map(
                      (post) {
                        return GestureDetector(
                          onTap: () async {
                            await launch(post.post_url.toString());
                          },
                          child: Container(
                            ...
                            child: FancyShimmerImage(
                              ...
                              imageUrl: post.photo_url.toString(),
                              boxFit: BoxFit.cover,
                            ),
                          ),
                        );
                  ...
                  options: CarouselOptions(
                    ...
                    autoPlayAnimationDuration: Duration(milliseconds: 340),
